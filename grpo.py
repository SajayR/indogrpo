...
TASK_SPECIFIC_INSTRUCTIONS = "You are evaluating whether the tutor reply identifies the student's mistake according to the rubric."
# --------------------------------------
# Distributed Setup
# --------------------------------------
...
# --------------------------------------
model_name = "Qwen/Qwen3-4B" # what I use: Llama-3.2-1B-Instruct
# Load tokenizer
